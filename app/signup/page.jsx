    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '400px', padding: '0 1.5rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '22px', fontWeight: '700', fontFamily: 'Georgia, serif' }}>Create your account</h1>
          <p style={{ color: '#555', fontSize: '14px', marginTop: '6px' }}>Free — 5 analyses per month to start</p>
        </div>
